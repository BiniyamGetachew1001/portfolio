...
import aboutImage from './images/portfolio_profile_picture.webp';
        ...
        <div className="flex gap-1 mb-8 p-1 bg-white/5 rounded-lg w-fit">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-md font-mono text-xs tracking-wider transition-all ${activeTab === tab.id
